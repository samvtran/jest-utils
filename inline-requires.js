/**
 * Based on 9a9c37f on Nov 7, 2015
 *
  ...
  return {
    visitor: {
      ...
      CallExpression: function(path) {
        ...
        if (isTopLevelRequireAlias(path, t)) {
          ...
          // This gets called multiple times in my experience and this check seems to do the trick for now
...
function isTopLevelRequireAlias(path, t) {
  return (
      isRequireCall(path.node, t) &&
